      ...
      >
        {text.map((item) => (
          <SwiperSlide key={item.name + item.date} className="w-full">
            <a href={item.link}>
              <div className=" bg-orange-100 flex flex-col justify-center items-start rounded-xl antialiased text-left space-y-1 font-poppins hover:cursor-pointer p-4 tracking-wide h-48 md:h-40">
